...
def download_data(args):
    ...
    if args.dataset_name == "speech-commands":
        tf.keras.utils.get_file('speech_commands_v0.01.tar.gz',
                                ...
                                extract=True)
    if args.dataset_name == "donatecry":
        tf.keras.utils.get_file('donatecry.zip',
                                'https://github.com/Nephys222/donateacry-cleaned/archive/main.zip',
                                cache_dir='./',
                                cache_subdir='dataset-donatecry',
                                extract=True)
